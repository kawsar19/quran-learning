            ...
            <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100">
              ...
              <div className="p-6">
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  পবিত্ র রামাদান উপলক্ ষে বিশেষভাবে আয়ো জন করা হয়েছে সহজ কো রআন শিক্ ষা কো র্ স।
এই কো র্ সটি তাদের জন্ য, যারা কো রআন পড়তে চান কিন্ তু এখনো শুদ্ ধভাবে পড়তে পারেন না অথবা বেসিক থেকে নতুন করে শিখতে চান।
                </p>
