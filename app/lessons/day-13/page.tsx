...
const ikhfaExamples = [
  ...
  { arabic: "نِعْمَةٍ تُجْزَى", bangla: "নি'মাতিং তুজযা", meaning: "প্রতিদান পাওয়ার নেয়ামত", letter: "ت" },
  ...
  { arabic: "اَنْجَيْنَا", bangla: "আংজাইনা", meaning: "আমরা রক্ষা করলাম", letter: "ج" },

  // د examples
  { arabic: "مَنْ دَسّٰهَا", bangla: "মাং দাসসাহা", meaning: "যে তাকে কলুষিত করেছে", letter: "د" },
  { arabic: "عِنْدَ", bangla: "ইংদা", meaning: "নিকটে", letter: "د" },
  { arabic: "وَكَأْسًا دِهَاقًا", bangla: "ওয়া কা'সাং দিহাক্বা", meaning: "পরিপূর্ণ পেয়ালা", letter: "د" },

  // ذ examples
  { arabic: "اَنْذَرْتُكُمْ", bangla: "আংযারতুকুম", meaning: "আমি তোমাদের সতর্ক করলাম", letter: "ذ" },
  { arabic: "يَتِيمًا ذَا مَقْرَبَةٍ", bangla: "ইয়াতীমাং যা মাক্বরাবা", meaning: "আত্মীয় এতিম", letter: "ذ" },

  // ز examples
  { arabic: "مَنْ زَكّٰهَا", bangla: "মাং যাক্কাহা", meaning: "যে তাকে পবিত্র করেছে", letter: "ز" },
  { arabic: "اَنْزَلْنَا", bangla: "আংযালনা", meaning: "আমরা নাযিল করেছি", letter: "ز" },

  // س examples
  { arabic: "اَمْرٍ سَلَامٌ", bangla: "আমরিং সালাম", meaning: "শান্তির বিষয়", letter: "س" },
  ...
  { arabic: "سَبْعًا شِدَادًا", bangla: "সাব'আং শিদাদা", meaning: "সাতটি শক্ত", letter: "ش" },

  // ص examples
  { arabic: "فَانْصَبْ", bangla: "ফাংসাব", meaning: "তুমি পরিশ্রম কর", letter: "ص" },
  { arabic: "صَفًّا صَفًّا", bangla: "সাফফাং সাফফা", meaning: "সারি সারি", letter: "ص" },

  // ض examples
  { arabic: "مِنْ ضَرِيعٍ", bangla: "মিং দারী'ইন", meaning: "কাঁটাযুক্ত গাছ থেকে", letter: "ض" },
  { arabic: "قَوْمًا ضَالِّينَ", bangla: "ক্বাওমাং দাল্লীন", meaning: "পথভ্রষ্ট জাতি", letter: "ض" },

  // ط examples
  { arabic: "مَنْ طَغٰى", bangla: "মাং ত্বাগা", meaning: "যে সীমালঙ্ঘন করেছে", letter: "ط" },
  { arabic: "كَشَجَرَةٍ طَيِّبَةٍ", bangla: "কাশাজারাতিং ত্বাইয়্যিবা", meaning: "পবিত্র গাছের মতো", letter: "ط" },

  // ظ examples
  { arabic: "يَنْظُرُ", bangla: "ইয়াংযুর", meaning: "সে দেখে", letter: "ظ" },
  { arabic: "لِبَعْضٍ ظَهِيرًا", bangla: "লিবা'দিং যাহীরা", meaning: "একে অপরের সাহায্যকারী", letter: "ظ" },

  // ف examples
  { arabic: "يَنْفَخُ", bangla: "ইয়াংফাখু", meaning: "ফুঁ দেওয়া হবে", letter: "ف" },
  { arabic: "اَنْفُسِكُمْ", bangla: "আংফুসিকুম", meaning: "তোমাদের নিজেদের", letter: "ف" },

  // ق examples
  { arabic: "يَنْقُضُونَ", bangla: "ইয়াংক্বুদুন", meaning: "তারা ভঙ্গ করে", letter: "ق" },
  { arabic: "عَذَابًا قَرِيبًا", bangla: "আযাবাং ক্বারীবা", meaning: "নিকটবর্তী শাস্তি", letter: "ق" },

  // ك examples
  { arabic: "مِنْ كُلِّ", bangla: "মিং কুল্লি", meaning: "প্রত্যেক থেকে", letter: "ك" },
  { arabic: "اِنْ كُنْتُمْ", bangla: "ইং কুংতুম", meaning: "যদি তোমরা হও", letter: "ك" },
];
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          ...
          <div className="bg-white rounded-xl p-5 border border-amber-200">
            ...
            <p className="text-center mt-4 text-gray-600">
              এই শব্দগুলোর মধ্যে{" "}
              <strong className="text-amber-600">"ং"</strong> এর যেই উচ্চারণ,
              সেই উচ্চারণটাই হচ্ছে ইখফার গুন্নাহ।
            </p>
          </div>
      ...
      <div className="bg-gray-800 text-white rounded-xl p-6 mb-10">
        ...
        <div className="text-center space-y-4">
          <div className="bg-gray-700/50 rounded-xl p-4 inline-block">
            ...
            <span className="mx-4 text-xl">=</span>
            <span className="text-amber-400 font-bold">গুন্নাহ (ং) দিয়ে পড়া</span>
          </div>
