...
const lessonData = [
  {
    day: 1,
    title: "হরফ পরিচিতি",
    desc: "আরবি ২৯টি হরফের শুদ্ধ উচ্চারণ ও পরিচয়।",
  },
  {
    day: 2,
  ...
  },
  {
    day: 3,
    title: "অক্ষর সংযোগ",
    desc: "একাধিক হরফ একসাথে যুক্ত হয়ে পড়ার নিয়ম।",
  },
  {
    day: 4,
    title: "সূরা আল-ফাতিহা",
    desc: " সূরা আল-ফাতিহা  হরফের বিভিন্ন রূপ ও পরিচয়।",
  },
  {
    day: 5,
    title: "হরকত (যবর, যের, পেশ)",
    desc: "আরবি স্বরচিহ্ন বা হরকতের ব্যবহার ও নিয়ম।",
  },
  {
    day: 6,
    title: "তানউইন পরিচয়",
  ...
  },
  {
    day: 9,
    title: "সুকুন বা জজম",
    desc: "সুকুন বা জজম এর নিয়ম ও উচ্চারণ পদ্ধতি।",
  },
];
      ...
      <div className="bg-gradient-to-br from-emerald-600 to-teal-700 text-white pt-16 pb-24 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <p className="text-emerald-100 text-lg md:text-xl opacity-90 max-w-2xl mx-auto">
            সহজ উপায়ে কুরআন শেখার একটি পূর্ণাঙ্গ কোর্স। প্রতিটি দিন ধাপে ধাপে
            নতুন কিছু শিখুন।
          </p>
        </div>
      </div>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <span className="block text-[10px] font-black text-emerald-400 uppercase tracking-widest leading-none mb-1">
                        Lesson
                      </span>
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed mb-6 line-clamp-2">
                    {lesson?.desc ||
                      "এই দিনের পাঠে আমরা নতুন কিছু গুরুত্বপূর্ণ নিয়ম শিখবো ইনশাআল্লাহ।"}
                  </p>
