...
const quizQuestions: QuizQuestion[] = [
  ...
  { arabic: "ش", correct: "শীন", options: ["সীন", "শীন", "সোয়াদ", "দোয়াদ"] },
  {
    arabic: "ص",
    correct: "সোয়াদ",
    options: ["শীন", "সোয়াদ", "দোয়াদ", "তোয়া"],
  },
  {
    arabic: "ض",
    correct: "দোয়াদ",
    options: ["সোয়াদ", "দোয়াদ", "তোয়া", "যোয়া"],
  },
  {
    arabic: "ط",
    correct: "তোয়া",
    options: ["দোয়াদ", "তোয়া", "যোয়া", "আইন"],
  },
  ...
  { arabic: "ي", correct: "ইয়া", options: ["ওয়াও", "ইয়া", "আলিফ", "বা"] },
  {
    arabic: "ء",
    correct: "হামযা",
    options: ["ইয়া", "হামযা", "আলিফ", "তা মারবুতা"],
  },
  {
    arabic: "ة",
    correct: "তা মারবুতা",
    options: ["হামযা", "তা মারবুতা", "আলিফ", "বা"],
  },
];
        ...
        <div className="mb-6">
          {percentage >= 80 && (
            <p className="text-emerald-700 font-medium">
              অসাধারণ! আপনি আরবি বর্ণমালা ভালোভাবে শিখেছেন!
            </p>
          )}
          {percentage >= 60 && percentage < 80 && (
            <p className="text-amber-700 font-medium">
              ভালো চেষ্টা! আরেকটু অনুশীলন করুন।
            </p>
          )}
          {percentage < 60 && (
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border-2 border-blue-200">
      ...
      <div className="text-center mb-8">
        ...
        <div
          className="text-9xl text-gray-800 mb-2 leading-[1.8]"
        ...
        {showResult && (
          <div className="text-center">
            {selectedAnswer === question.correct ? (
              <p className="text-emerald-600 font-bold mb-4 text-lg">
                ✓ সঠিক! Correct!
              </p>
            ) : (
