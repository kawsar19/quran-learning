  ...
  return (
    <div className="py-3">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        {hasPrevious ? (
          ...
          >
            ...
            <div className="hidden sm:block text-left">
              ...
              <p className="text-sm md:text-base font-bold text-gray-800 group-hover:text-emerald-700">
                Day {currentDay - 1}
              </p>
            </div>
          </Link>
        ...
        {hasNext ? (
          isNextLocked ? (
            <div className="px-3 py-2.5 md:px-4 md:py-3 bg-gray-100 rounded-xl border border-gray-200 opacity-60 cursor-not-allowed">
            ...
            >
              <div className="hidden sm:block text-right">
                <p className="text-[10px] md:text-xs text-emerald-100 font-medium">
                  পরের দিন
                </p>
